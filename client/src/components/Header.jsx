    ...
    return (
        <div className='flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20'>
            ...
            <div>
                ...
                <p className='my-6 text-[15px] text-gray-500'>Instantly remove backgrounds from any image with precision. <br className='max-sm:hidden' />  Free, fast, and easy – perfect for e-commerce, design, and editing.</p>
                <div>
